...
object CoinChange2 extends App {
  ...
  object Solution {
    def change(amount: Int, coins: Array[Int]): Int = {
      ...
      def find(currAmount: Int, remainingCoins: Seq[(Int, Int)]): Int = {
          ...
          remainingCoins.headOption match {
            case Some((headCoin, headCoinIndex)) =>
              if(array(headCoinIndex)(currAmount) != -1) {
                ...
                val a = find(currAmount + headCoin, remainingCoins) + find(currAmount, remainingCoins.tail)
                array(headCoinIndex)(currAmount) = a
                a
              }
            case None =>
              0
      ...
      find(0, coins.toSeq.filter(_ <= amount).zipWithIndex)
    }
  }
